...
public final class FireballSImulator {
    ...
    public static Result simulate(EntityLargeFireball fireball) {
        return simulate(fireball, null, DEFAULT_MAX_TICKS);
    }

    public static Result simulate(EntityLargeFireball fireball, Vec3 accelerationOverride) {
        return simulate(fireball, accelerationOverride, DEFAULT_MAX_TICKS);
    }

    public static Result simulate(EntityLargeFireball fireball, int maxTicks) {
        return simulate(fireball, null, maxTicks);
    }

    private static Result simulate(EntityLargeFireball fireball, Vec3 accelerationOverride, int maxTicks) {
        if (fireball == null) {
        ...
        double accelerationX = accelerationOverride != null ? accelerationOverride.xCoord : fireball.accelerationX;
        double accelerationY = accelerationOverride != null ? accelerationOverride.yCoord : fireball.accelerationY;
        double accelerationZ = accelerationOverride != null ? accelerationOverride.zCoord : fireball.accelerationZ;
