...
public class AutoClicker extends Module {
    ...
    private boolean isControllingAttack;
    ...
    public void onEnable() {
        ...
        this.isControllingAttack = false;
    ...
    public void onPrePlayerInteract(PrePlayerInteractEvent e) {
        ...
        if (!Utils.nullCheck()
                ...
                || (disableCreative.isToggled() && mc.thePlayer.capabilities.isCreativeMode)
        ...
        if (Mouse.isButtonDown(0)) {
            this.isControllingAttack = true;
            if (breakBlocks.isToggled() && mc.thePlayer.capabilities.allowEdit
    ...
    private void releaseAttackControl() {
        if (this.isControllingAttack) {
            KeyBinding.setKeyBindState(mc.gameSettings.keyBindAttack.getKeyCode(),
                    mc.currentScreen == null && mc.inGameHasFocus && Mouse.isButtonDown(0));
            this.isControllingAttack = false;
        }
        this.nextClickTime = 0L;
    }
