...
public class Displace extends Module {
    ...
    public void onClientRotation(ClientRotationEvent e) {
        ...
        boolean killAuraIsAttacking = ModuleManager.killAura != null
                && ModuleManager.killAura.isEnabled()
                && KillAura.attackingEntity != null;
        if (killAuraIsAttacking) {
            target = CombatTargeting.asValidPlayer(KillAura.attackingEntity, 9.0, ignoreTeammates.isToggled());
        } else if (Mouse.isButtonDown(0)) {
            target = CombatTargeting.getMouseOverTarget(9.0, ignoreTeammates.isToggled());
        }
