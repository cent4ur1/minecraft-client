...
public class AutoBlockin extends Module {
    ...
    public AutoBlockin() {
        ...
        this.registerSetting(showProgress = new SliderSetting("Show progress", true, 0, new String[]{"Circle", "Percentage"}));
    ...
    public void onClientRotation(ClientRotationEvent e) {
        ...
        double r = REACH;
        MovingObjectPosition mop = RotationUtils.rayCastBlock(r,
        ...
        if (mop != null) {
            ...
            if (hitBlock.equals(targetHitPos) && side == targetSide) {
                ...
                if (Math.abs(MathHelper.wrapAngleTo180_float(sm[0] - RotationUtils.serverRotations[0])) <= tol
    ...
    public void onRenderTick(TickEvent.RenderTickEvent e) {
        ...
        int progressMode = (int) showProgress.getInput();
