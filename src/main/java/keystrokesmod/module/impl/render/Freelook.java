...
public class Freelook extends Module {
    ...
    public void resetPerspective() {
        ...
        if (mc.currentScreen == null && mc.inGameHasFocus && !Mouse.isGrabbed()) {
    ...
    public static boolean overrideMouse(Minecraft mc) {
        ...
        if (Minecraft.isRunningOnMac && Display.isActive() && !Mouse.isInsideWindow()) {
            Mouse.setGrabbed(false);
            Mouse.setCursorPosition(mc.displayWidth / 2, mc.displayHeight / 2 - 20);
