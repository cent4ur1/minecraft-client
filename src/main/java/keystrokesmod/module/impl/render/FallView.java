...
public class FallView extends Module {
    ...
    private ButtonSetting showRemainingHealth;
    ...
    public FallView() {
        ...
        this.registerSetting(showRemainingHealth = new ButtonSetting("Show remaining health", false));
    }
    @Override
    public void onDisable() {
        ...
        damageCache.clear();
        recalculateAfterTeleport = false;
        clearOverlayState();
    }
    ...
    public void onClientTick(TickEvent.ClientTickEvent ev) {
        ...
        if (recalculateAfterTeleport) {
            recalculateAfterTeleport = false;
            recalculateFallTracking();
        }
