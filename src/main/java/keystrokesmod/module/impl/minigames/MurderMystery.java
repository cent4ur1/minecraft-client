...
public class MurderMystery extends Module {
    ...
    public MurderMystery() {
        ...
        this.registerSetting(goldEsp = new ButtonSetting("Gold ingots", true));
                            ...
                            if (murderWeapons.matches(heldStack)) {
                                if (!murderers.contains(en)) {
                                    ...
                                    if (alert.isToggled()) {
                                        ...
                                        Utils.sendMessage("&b" + en.getName() + " &7is the &cmurderer&7! " + Utils.getDistanceColor(mc.thePlayer.getDistanceToEntity(en)) + (int) mc.thePlayer.getDistanceToEntity(en) + "m&r");
                                    }
                                }
                            }
