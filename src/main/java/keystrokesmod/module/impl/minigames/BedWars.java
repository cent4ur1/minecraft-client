...
public class BedWars extends Module {
    ...
    private final ButtonSetting targetUnicorn;
    ...
    public BedWars() {
        ...
        this.registerSetting(targetUnicorn = new ButtonSetting("Target unicorn", false));
    ...
    public static boolean shouldTargetUnicorn() {
        return ModuleManager.bedwars != null && ModuleManager.bedwars.isEnabled()
                && ModuleManager.bedwars.targetUnicorn.isToggled() && Utils.getBedwarsStatus() == 2;
    }
