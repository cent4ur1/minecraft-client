...
import keystrokesmod.module.impl.network.*;
import keystrokesmod.module.impl.render.ExtraBobbing;
...
public class ModuleManager {
    ...
    public static keystrokesmod.script.Manager scriptManager;
    public static InvManager inventory;
    ...
    public void register() {
        ...
        this.addModule(inventory = new InvManager());
        ...
        this.addModule(scriptManager = new keystrokesmod.script.Manager());
