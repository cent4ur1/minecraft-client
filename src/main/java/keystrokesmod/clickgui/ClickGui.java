...
import keystrokesmod.clickgui.components.impl.SliderComponent;
...
public class ClickGui extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float p) {
        ...
        this.renderClientInfo(this.height + 8 - this.logoSmoothWidth.getValueInt(0, 30, 2), this.fontRendererObj);
        ...
        updateHeldSliderAdjustment(logicalMouseX, logicalMouseY);

        GL11.glColor3f(1.0f, 1.0f, 1.0f);
        if (!Gui.hidePlayerModel.isToggled()) {
            GlStateManager.pushMatrix();
    ...
    private void renderClientInfo(int y, FontRenderer fontRenderer) {
        fontRenderer.drawStringWithShadow("raven bs " + Raven.VERSION, 4.0f, (float)y + 10, Gui.INFO_COLOR);
    }
