...
public class BindComponent extends Component {
    ...
    public void render() {
        ...
        if (keySetting == null && moduleComponent.mod.canBeEnabled() && moduleComponent.mod.moduleCategory() != Module.category.profiles) {
    ...
    public boolean onClick(int x, int y, int button) {
        ...
        if (button == 0 && moduleComponent.mod.canBeEnabled() && moduleComponent.mod.moduleCategory() != Module.category.profiles && overEyeIcon(x, y)) {
